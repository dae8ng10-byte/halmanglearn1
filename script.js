...
const missions = [
    ...
    { id: 'guard', name: '수호의 조각', location: '돌문화공원', isCollected: false, imagePath: './seed_wish.png' },
    { id: 'peace', name: '평화의 바람개비', location: '4.3 평화공원', isCollected: false, imagePath: './seed_peace.png' }
];
const dialogues = [
